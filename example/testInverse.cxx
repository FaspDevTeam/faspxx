...
int main(){
    ...
    values1[2]=2; values1[3]=3; values1[4]=4;
    values1[5]=5; values1[6]=2; values1[7]=1;
    values1[8]=2; values1[9]=1;

    colInd1[0]=0; colInd1[1]=2;
    colInd1[2]=0; colInd1[3]=1; colInd1[4]=3;
    colInd1[5]=0; colInd1[6]=2; colInd1[7]=3;
    colInd1[8]=2; colInd1[9]=3;

    rowPtr1[0]=0; rowPtr1[1]=2; rowPtr1[2]=5; rowPtr1[3]=8; rowPtr1[4]=10;
