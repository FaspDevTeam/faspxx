...
if(USE_UMFPACK)
    ...
    if (UMFPACK_FOUND)
        ...
        message("-- WARNING: UMFPACK requested but not supported! Continue without it.")
    endif(UMFPACK_FOUND)
...
if(USE_SUPERLU)
    ...
    if (SUPERLU_FOUND)
        ...
        message("-- WARNING: SuperLU requested but not supported! Continue without it.")
    endif(SUPERLU_FOUND)
...
if(USE_MUMPS)
    ...
    if (MUMPS_FOUND)
        ...
        message("-- WARNING: MUMPS requested but not supported! Continue without it.")
    endif(MUMPS_FOUND)
...
if(USE_PARDISO)
    ...
    if (MKL_FOUND)
        ...
        message("-- WARNING: Intel MKL requested but not supported! Continue without it.")
    endif(MKL_FOUND)
...
if(USE_DOXYGEN)
    ...
    if(DOXYGEN_FOUND)
        if(EXISTS ${FASP_SOURCE_DIR}/doc/fasp.Doxygen.cnf.in)
            ...
            message("-- WARNING: Doxygen configuration cannot be found! Continue without it.")
